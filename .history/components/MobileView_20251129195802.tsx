  ...
  return (
    <div
      className={`h-12 ${
        light
          ? "bg-transparent"
          : "bg-white/80 dark:bg-black/90 backdrop-blur-xl"
      } text-gray-900 dark:text-white flex items-center justify-between px-6 safe-area-top`}
    >
...
const MobileAppIcon = ({
  ...
  >
    <div className="w-16 h-16 rounded-2xl bg-white/20 dark:bg-white/10 backdrop-blur-xl flex items-center justify-center shadow-lg overflow-hidden relative">
      <Image
        src={app.icon}
        alt={app.title}
        fill
    ...
    <span className="text-xs font-medium truncate max-w-[70px] px-1.5 py-0.5 rounded bg-white/60 dark:bg-black/40 text-gray-900 dark:text-white backdrop-blur-sm">
      {app.title}
    </span>
  </button>
);
    ...
    if (navigation.type === "project") {
      return (
        <div className="flex-1 flex flex-col bg-gray-100 dark:bg-gray-900">
          <div className="h-12 bg-gray-200 dark:bg-gray-800 flex items-center px-4 gap-3">
            <button
              onClick={handleBack}
            ...
            <span className="text-gray-900 dark:text-white font-medium truncate flex-1 text-center pr-10">
    ...
    return (
      <div className="flex-1 flex flex-col bg-gray-100 dark:bg-gray-900">
        <div className="h-12 bg-gray-200 dark:bg-gray-800 flex items-center px-4 gap-3">
          ...
          <span className="text-gray-900 dark:text-white font-medium flex-1 text-center pr-10">
            ...
            <div className="grid grid-cols-2 gap-4">
              {projects.map((project) => (
                <button
                  ...
                  className="bg-white dark:bg-gray-800 rounded-xl p-3 text-left active:bg-gray-50 dark:active:bg-gray-700 transition-colors shadow-sm"
                >
                  <div className="aspect-video rounded-lg overflow-hidden mb-3 bg-gray-200 dark:bg-gray-700 relative">
                  ...
                  <div className="flex flex-wrap gap-1 mt-2">
                    {project.tags?.slice(0, 3).map((tag: string, i: number) => (
                      <span
                        key={i}
                        className="text-[10px] px-2 py-0.5 bg-blue-500/20 text-blue-600 dark:text-blue-400 rounded-full"
                      >
                        {tag}
                      </span>
                    ))}
