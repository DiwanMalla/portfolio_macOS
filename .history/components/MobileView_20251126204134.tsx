...
const MobileAppIcon = ({
  ...
  app: { id: string; title: string; icon: string };
  onClick: () => void;
}) => (
  <button
    onClick={onClick}
  ...
  >
    <div className="w-16 h-16 rounded-2xl bg-white/10 backdrop-blur-xl flex items-center justify-center shadow-lg overflow-hidden">
          ...
          <div className="p-4">
            <div className="grid grid-cols-2 gap-4">
              {projects.map((project) => (
                ...
                >
                  <div className="aspect-video rounded-lg overflow-hidden mb-3 bg-gray-700">
                    {project.image && (
                      <img
                        src={project.image}
                        alt={project.title}
