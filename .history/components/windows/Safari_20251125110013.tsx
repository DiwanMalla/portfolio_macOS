          ...
          <div className="max-w-4xl mx-auto p-8">
            <div className="mb-8">
              ...
              <div className="flex flex-wrap gap-4 text-sm text-gray-600 dark:text-gray-400 mb-6 border-b border-gray-200 dark:border-gray-700 pb-6">
                {project.client && (
                  <div className="flex items-center gap-2">
                    <span className="font-semibold text-gray-900 dark:text-gray-200">Client:</span>
                    <span>{project.client}</span>
                  </div>
                )}
                {project.projectCategory && project.projectCategory.length > 0 && (
                  <div className="flex items-center gap-2">
                    <span className="font-semibold text-gray-900 dark:text-gray-200">Category:</span>
                    <span>{project.projectCategory.join(", ")}</span>
                  </div>
                )}
                {project.createdAt && (
                  <div className="flex items-center gap-2">
                    <span className="font-semibold text-gray-900 dark:text-gray-200">Date:</span>
