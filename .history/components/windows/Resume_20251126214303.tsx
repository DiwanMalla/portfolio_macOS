  ...
  if (isMobile || showPdfFallback) {
    return (
      <div className="h-full flex flex-col bg-gray-100 dark:bg-gray-900">
        {/* Mobile Toolbar */}
        <div className="min-h-[56px] bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row items-center justify-between px-3 py-2 gap-2">
