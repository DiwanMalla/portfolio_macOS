...
export default function AboutMe() {
  const profile = {
    ...
    salary_location: {
      ...
      relocation_details:
        "Open to relocation within Australia for the right opportunity with relocation support",
      remote_experience:
        "3+ years remote collaboration experience across distributed teams",
      remote_setup:
        "Professional home office setup with high-speed internet, dedicated workspace",
      work_authorization:
        "International student, immediate to work, happy to volunteer",
    ...
    experience: [
      {
        ...
        company_context:
          "Tech startup focusing on SaaS applications and UX-driven web solutions",
        highlights: [
      ...
      },
      {
        ...
        company_context:
          "Local web development projects and WordPress customizations",
        highlights: [
    ...
    projects: [
      ...
      },
      {
        name: "PDFly",
        description:
          "Smart PDF management platform for compress, merge, split, convert, and secure PDFs",
        technologies: [
          "Next.js 15",
          "React 19",
          "TypeScript",
        ...
        impact:
          "100+ documents processed daily, 45% improved user satisfaction",
        link: "https://pdf-fast-fly.vercel.app/",
      },
      {
        name: "BrainiX",
        description:
          "AI-powered e-learning platform with personalized learning, smart assessments, and Stripe payments",
        technologies: [
          "Next.js 14",
          "React",
          "TypeScript",
        ...
        impact:
          "Led 3-member team, 300% engagement increase, 94.7% course completion rate",
        link: "https://braini-x-one.vercel.app",
      },
      {
        name: "SangeetX",
        description:
          "Modern music streaming platform with admin dashboard and guest experience",
        technologies: [
          "Next.js 15",
          "React 19",
          "TypeScript",
      ...
      },
      {
        name: "ChatSphere",
        description:
          "Real-time chat application with private messaging, group chats, and media sharing",
        technologies: [
          "React.js",
          "Node.js",
          "Express.js",
      ...
      },
      {
        name: "SmartSpend",
        description:
          "Budget tracker with transaction management, category insights, and interactive visualizations",
        technologies: [
          "Next.js",
          "TypeScript",
          "Prisma",
      ...
      },
      {
        ...
        description:
          "Real-time weather app with interactive charts, search history, and city favorites",
        technologies: [
          "Next.js",
          "React.js",
          "TypeScript",
    ...
    certifications: [
      ...
      {
        name: "Meta Front-End Specialization",
        issuer: "Meta",
        year: 2024,
        skills: [
          "React",
    ...
    career_goals: {
      ...
      short_term:
        "Mid to Senior Full-Stack Developer role focusing on React/Next.js ecosystem, SaaS platforms, and AI-powered web applications",
      long_term:
        "Technical Lead, Engineering Manager, or Head of Engineering in an AI/ML driven SaaS company",
      ideal_roles: [
      ...
      open_to_learning:
        "Willing to learn C#/.NET/Angular for the right role with mentorship support",
    },
  };
        ...
        >
          <div className="space-y-4">
            ...
            <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border-l-4 border-purple-500">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Major: {profile.education.masters.major} •{" "}
                {profile.education.masters.years}
              </p>
            </div>
            <div>
              <h4 className="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">
                  ...
                  >
                    ...
                    <div className="flex flex-wrap mt-2 pl-6">
                      {cert.skills.map((skill) => (
                        <span
                          key={skill}
                          className="text-xs px-2 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded mr-1 mb-1"
                        >
                          {skill}
                        </span>
                      ))}
        ...
        >
          <div className="space-y-4">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-300 space-y-2 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
              ...
              <p>
                💻 <span className="font-medium">Remote Experience:</span>{" "}
                {profile.salary_location.remote_experience}
              </p>
              <p>
                🏠 <span className="font-medium">Setup:</span>{" "}
                {profile.salary_location.remote_setup}
              </p>
              <p>
                🌏 <span className="font-medium">Relocation:</span>{" "}
                {profile.salary_location.relocation_details}
              </p>
            </div>
          </div>
        </CollapsibleSection>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 text-sm space-y-1">
                {profile.professional_development.recent_learning.map(
                  (item, i) => (
                    <li key={i}>{item}</li>
                  )
                )}
            ...
            <div>
              ...
              <div className="grid gap-2">
                {profile.professional_development.learning_agility.map(
                  (item, i) => (
                    <div
                      key={i}
                      className="p-2 bg-green-50 dark:bg-green-900/20 rounded text-sm text-gray-700 dark:text-gray-300"
                    >
                      ✓ {item}
                    </div>
                  )
            ...
            <div>
              ...
              <div className="flex flex-wrap">
                {profile.career_goals.ideal_roles.map((role) => (
                  <span
                    key={role}
                    className="inline-block px-3 py-1.5 text-sm font-medium bg-green-100 dark:bg-green-900/40 text-green-700 dark:text-green-300 rounded-full mr-2 mb-2"
                  >
                    {role}
                  </span>
                ))}
