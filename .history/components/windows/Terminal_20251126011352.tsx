...
export default function Terminal() {
  ...
  return (
    <div className="h-full bg-gradient-to-br from-gray-900 via-black to-gray-900 p-6 font-mono text-sm overflow-hidden flex flex-col">
      ...
      >
        {history.map((item, index) => (
          ...
          >
            ...
            {item.type === "ai" && (
              <div className="bg-gradient-to-r from-cyan-950/20 to-transparent border-l-2 border-cyan-500 pl-4 py-2 rounded-r">
