...
export default function Figma() {
  return (
    <div className="h-full bg-linear-to-br from-purple-50 via-pink-50 to-blue-50 dark:from-gray-900 dark:via-purple-900/20 dark:to-gray-900">
      {/* Figma Toolbar */}
      ...
      <div className="h-[calc(100%-60px)] flex items-center justify-center p-8">
        <div className="text-center max-w-md">
          <div className="relative inline-block mb-6">
            ...
            <div className="relative bg-linear-to-br from-purple-500 to-pink-500 p-6 rounded-2xl">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Design explorations and creative work are on the way. Stay tuned for
            something special.
          </p>
