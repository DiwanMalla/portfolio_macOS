            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {filteredProjects.map((project) => (
                <a
                  ...
                  title={project.title}
                >
                  <div className="w-16 h-16 relative flex items-center justify-center text-gray-400 bg-gray-100 dark:bg-gray-800 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 shadow-sm group-hover:shadow-md transition-all">
                  ...
                  <div className="text-center w-full">
                    <div className="text-xs font-medium text-gray-700 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 line-clamp-2 break-words leading-tight">
                      {project.title}
                    </div>
