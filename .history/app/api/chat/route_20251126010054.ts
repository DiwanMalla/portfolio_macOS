export async function POST(req: Request) {
  try {
    ...
    // Call the Digital Twin MCP Server with enhanced prompt
    const enhancedQuery = `${userQuery}

Please provide a detailed and comprehensive response with specific examples, numbers, dates, and technologies used. Include all relevant details from the knowledge base.`;
